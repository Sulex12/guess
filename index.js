...
function validateGuess(guess){
    if (isNaN(guess)){
        ...
        if (numGuesses === 11){
            ...
            displayMessage(`Game Over! &#128553 Number was ${randomNumber} &#128579`);
            endGame();
        } else {
...
function checkGuess(guess){
    ...
    if (guess === randomNumber){
        displayMessage(`You guessed correctly! &#127881`);
        endGame();
    } else if (guess < randomNumber) {
        displayMessage(`Too low! &#128540 Try again!`);
    } else if (guess > randomNumber) {
        displayMessage(`Too High! &#128541 Try again!`);
    }
}
